...
function About({ featuredServices }) {
  return (
    <div className="bg-black/90 text-white">
      ...
      <hr />
      <div className="flex flex-col md:max-w-1/2 p-8 md:p-20 gap-5 md:gap-10">
        <h2 className="text-2xl md:text-5xl">Our Mission</h2>
        <p className="md:text-2xl">
          To empower businesses with innovative digital solutions that inspire
          growth, creativity, and success.
        </p>
      </div>
      <hr className="w-1/2 md:border-2" />
      <div className="flex flex-col md:max-w-1/2 p-5 md:p-20 gap-5 md:gap-10 ms-auto">
        <h2 className="text-2xl md:text-5xl">Our Vision</h2>
        <p className="md:text-2xl">
      ...
      <div>
        ...
        <div className="flex flex-col p-10 md:p-20 items-center text-center gap-6">
          ...
          <p className="md:text-2xl md:mx-20 tracking-wide text-red-300/80">
