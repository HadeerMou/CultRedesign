  ...
  return (
    <div>
      ...
      <div className="flex flex-col bg-black py-15 md:px-8 text-white font-bold">
        ...
        <p className="md:text-2xl md:my-14 my-3 max-w-3/4 md:max-w-1/2 mx-auto">
        ...
        <Link
          className="text-center text-sm md:text-lg underline text-red-200 hover:text-red-300 duration-300 transform"
          to="/about"
        >
          Read Our Story
        </Link>
